...
<html>
    ...
    <body>
        ...
        <div class="row-fluid" style=" width: 80%; padding:0 10%;">
            <div class="span10">
                <%-- Formulario con los posibles tipos de usuario --%>   
                <form:form class="form-horizontal" action="${pageContext.request.contextPath}/admin/seleccionado" method="post" modelAttribute="rolBean">
                    <div class="control-group">
                        <label class="control-label">Usuario a agregar</label>
                        <div class="controls">
                            <form:select path="idrol" class="span4">
